...
class StudentAdvisor:
    ...
    def _select_best_university(self, student):
        # This function selects the best university based on some criteria
    ...
    def recommend_university(self, student_input):
        # Recommend a university based on user input
        student = {
        ...
        university = self._select_best_university(student)
        return university


# Sample university data (the same as before)
universities = [
...
# You don't need to define student data here as we're using user input directly.

# Create the advisor and train the model
advisor = StudentAdvisor([], universities)
